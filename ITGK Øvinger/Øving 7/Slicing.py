...
set("I Was Told There’d Be Cake")
...
def set2(liste):
    ...
    for i in liste:
        streng=i
        bokstaver+=streng[len(streng)-2]+streng[len(streng)-1]
    return bokstaver

print(set2(["banan","propan","Westerosi"]))
...
#Kodesnutt 1
streng = "I Want Cake"
streng[7:] = "Cupcake"  #kan ikke bytte ut en streng
print(streng)
...
#Kodesnutt 3
streng = "I Want Cake"
streng = streng[]     #kan ikke være tom
print(streng)


# Dobbeltklikk på teksten under og skriv svaret ditt i boksen.

# Ditt svar: Kodesnutt 2 er rett
