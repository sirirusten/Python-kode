...
print('Norge')          
print()                         #en tom linje
print('Areal (kv.km):',385180)      #tallene er ikke som en del av teksten
...
print('"Jeg elsker ITGK" ropte studenten da lc funket')     #må bruke apostrof da det er hermetegn i teksten
#print("Hei')
...
print('Dette er ikke en kommentar. Mangler #.')
