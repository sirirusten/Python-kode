...
import math
h = 3
print('Et tetraeder med høyde', h ,'har areal',math.sqrt(3)*(3/(math.sqrt(6))*h)**2) 
print('Et tetraeder med høyde',h,'har volum',math.sqrt(2)/12*(3/(math.sqrt(6))*h)**3) 
...
print('Et tetraeder med høyde',h,'har volum',math.sqrt(2)/12*(3/(math.sqrt(6))*h)**3,'og areal',math.sqrt(3)*((3/(math.sqrt(6))*h)**2))
