...
# Svar: lager en liste med tallene i a i en tilfeldig rekkefølge
...
# 1. sorterer tallene i stigende rekkefølge
# 2. lager en ny liste med tallene fra liste en og to
# 3. legger til 9 og 10
# 4. fjerner tallet 1 fra lista
# 5. liste tre i den motsatte rekkefølgen
# Altså 10,9,8,7,6,5,4,3,2
